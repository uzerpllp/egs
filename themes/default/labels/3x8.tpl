...
<body>
 ...
 <input type='hidden' name='layout_cols' value='3' />
 <input type='hidden' name='layout_rows' value='8' />
 <input type='hidden' name='cell_width' value='70' />
 <input type='hidden' name='cell_height' value='36' />
 <input type='hidden' name='margin_top' value='8' />
 <input type='hidden' name='margin_left' value='3' />
