...
function WriteHTML($html)
{
    ...
    $html=strip_tags($html,"<q><b><u><i><h1><h2><a><img><p><br><strong><em><font><tr><blockquote><hr><td><tr><table><sup>"); //remove all unsupported tags
...
function OpenTag($tag,$attr)
{
    ...
    switch($tag){
        ...
        case 'TD': // TD-BEGIN
            ...
            else $this->tdwidth=35; // SET to your own width if you need bigger fixed cells
