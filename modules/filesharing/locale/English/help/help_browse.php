...
<img src="../../../graphics/<? echo $default->sButtonStyle ?>/ui_misc/owl_logo1.gif" width="99" height="53" border="0" alt=""></img><br></br></center>
<hr></hr>
...
Documents that are uploaded into the Owl system are stored in folders and each folder can have a series of sub folders. This type of structure is known as a hierarchical structure and is typically used for the storage and organization of files onyour computers hard drive. In Owl, the start point of the hierarchy (or root) is known as the <i>documents</i> folder.The folder structure allows a convenient way to group documents in a meaningful fashion. For instances you may wish to capture all your technical documents for a number of products. You could create a folder named technical documents and thena series of sub folders in side technical documents of each product. For this to work properly, you must chose sensible and descriptive folder names that provide the user with a reasonable description and meaning.
...
<td nowrap="nowrap"><?php fPrintSubmitButton($owl_lang->btn_bulk_download, $owl_lang->alt_btn_bulk_download, "reset", "") ?></td>
      ...
      <td>Download selected files.<br></br></td>
    </tr>
 <tr>
      <td>
<table>
...
<td nowrap="nowrap"><?php fPrintSubmitButton($owl_lang->btn_bulk_move, $owl_lang->alt_btn_bulk_move, "reset", "") ?></td>
      ...
      <td>Move selected files to another folder.<br></br></td>
    </tr>
 <tr>
      <td>
<table>
...
<td nowrap="nowrap"><?php fPrintSubmitButton($owl_lang->btn_bulk_email, $owl_lang->alt_btn_bulk_email, "reset", "") ?></td>
      ...
      <td>E-mail selected files to somebody.<br></br>
      </td>
    </tr>
 <tr>
      <td>
...
<td nowrap="nowrap"><?php fPrintSubmitButton($owl_lang->btn_bulk_delete, $owl_lang->alt_btn_bulk_delete, "reset", "") ?></td>
      ...
      <td>Delete selected files. Note that you cannot delete selected folders.<br></br>
      </td>
    </tr>
 <tr>
      <td>
...
<td nowrap="nowrap"><?php fPrintSubmitButton($owl_lang->btn_bulk_checkout, $owl_lang->alt_btn_bulk_checkout, "reset", "") ?></td>
      ...
      <td>Checkout selected files. Note that no other user can modify a file that is checked out by another user.<br></br>
      </td>
    </tr>
</table>
<br></br>
